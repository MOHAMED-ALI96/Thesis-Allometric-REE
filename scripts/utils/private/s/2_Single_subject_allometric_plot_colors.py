...
# Print filtered data for the subject in tabular format
print("\nFiltered Data for Subject ID:", target_subject, "Study ID:", target_study)
print(df_subject[x_columns + y_columns].to_string(index=False))
